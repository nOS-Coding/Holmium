...
# Leaves space for Debian dual boot.
...
pacstrap "$MOUNT" base linux linux-firmware grub efibootmgr os-prober openrc eudev networkmanager wireguard-tools python python-pip git vim htop chrony plymouth tzdata dosfstools
